...
function openProduct(id) {
  ...
  $('#detailGallery').innerHTML = images.length ? images.map(image => `<img src="/uploads/${encodeURIComponent(image)}" alt="${esc(product.title)}">`).join('') : '<div class="detail-placeholder">Нет изображения</div>';
